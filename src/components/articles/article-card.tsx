...
export function ArticleCard({ article, className }: ArticleCardProps) {
  ...
  return (
    <Link
      ...
      className={cn(
        "group block p-6 rounded-xl border border-gray-200 dark:border-gray-800",
        "bg-white dark:bg-gray-950",
        "hover:border-[#088395] dark:hover:border-[#7AB2B2]",
        "hover:shadow-lg hover:shadow-[#088395]/5 dark:hover:shadow-[#7AB2B2]/5",
        "transition-all duration-200",
        className
      )}
    >
      <div className="flex items-start gap-4">
        <div className="flex-shrink-0 p-3 rounded-lg bg-[#EBF4F6] dark:bg-[#09637E]/20">
